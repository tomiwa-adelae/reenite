...
export const EditDailyPricingComponent = ({
	userId,
	spaceId,
	initialPricing = {},
	closeSmallModal,
	...
	const onSubmit = async (data: z.infer<typeof FormSchema>) => {
		...
		try {
			...
			const res = await addSpaceDailyPricing({
				dailyPricing: cleanedPricing,
				userId,
				spaceId,
			});

			if (res.status === 400) return toast.error(res.message);
			toast.success("Daily pricing successfully updated!");
