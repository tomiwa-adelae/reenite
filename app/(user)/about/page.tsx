	...
	return (
		<div>
			<div className="container">
				<h2 className="font-semibold text-3xl flex items-center justify-start">
					<span>About me </span>
					<Button
						size="sm"
						variant={"ghost"}
						className="bg-[#F2F2F2] px-4 py-4 rounded-lg ml-6 font-semibold"
					>
						Edit
					</Button>
				</h2>
				...
				<div className="mt-10 space-y-4">
					<p className="text-lg">
						<BriefcaseBusiness className="size-7 inline-block mr-3" />
